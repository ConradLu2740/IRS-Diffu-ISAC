...
| Information audit | Fano ladder **0.19 / 1.71 / 2.07 bit** (narrowband→HRRP→ISAR); Van Trees λ⊥/λ∥~6.6e-9 (angle wall); conditional-encoder collapse **fixed** (lr_cond 1e-3→1e-4; sensitivity ×4×10⁴) — side-information gap still ~0 (G15 partially falsified) |
